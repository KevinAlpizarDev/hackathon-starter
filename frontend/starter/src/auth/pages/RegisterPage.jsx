        ...
        <AuthLayout title='HOLI'>
            <form className="space-y-4 " action="#">
                ...
                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                    Ya tengo una cuenta <Link to='/auth/login' className="font-medium text-primary-600 hover:underline dark:text-primary-500">Ingresar</Link>
                </p>
            </form>
